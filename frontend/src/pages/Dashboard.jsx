    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-8 text-white mb-8">
          ...
          <p className="text-indigo-100">Ready to study today? Let's check your progress.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div 
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-1">Take Quiz</h3>
          ...
          <div 
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-1">Weakness Report</h3>
          ...
          <div 
            ...
            <h3 className="text-lg font-bold text-gray-800 mb-1">AI Roadmap</h3>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Choose a Subject</h2>
